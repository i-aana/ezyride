...
interface FinalReviewStepProps {
  ...
  submitAttempted?: boolean; // 🔥 Submit attempt state
}
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 pt-6">
        ...
        <button
          ...
          disabled={isSubmitting || submitAttempted} // 🔥 Disable after first attempt
        >
          {isSubmitting && <Loader2 className="w-4 h-4 animate-spin" />}
          {isSubmitting ? 'Submitting...' : submitAttempted ? 'Request Submitted' : 'Submit Request'}
        </button>
      </div>
